        ...
        <div class="dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
            <form action="{{ route('sueldo.update', $sueldo->id) }}" method="POST" class="max-w-sm mx-auto space-y-4">
                ...
                <div>
                    ...
                    <input type="text" value="{{ $trabajador->numero_identificacion }} - {{ $trabajador->nombre }} - {{ $trabajador->apellido }}" disabled class="bg-gray-900 border border-gray-100 text-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                </div>

                <div class="">
                    <label for="sueldo" class="block mb-2 text-sm font-medium text-gray-100">sueldo</label>
                    <input type="number" id="sueldo" name="sueldo" value="{{ $sueldo->sueldo }}" class="bg-gray-900 border border-gray-300 text-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                </div>

                <div class="">
                    <label for="auxilio_transporte" class="block mb-2 text-sm font-medium text-gray-100">auxilio_transporte</label>
                    <input type="number" id="auxilio_transporte" name="auxilio_transporte" value="{{ $sueldo->auxilio_transporte }}" class="bg-gray-900 border border-gray-300 text-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                </div>

                <div class="">
                    <label for="" class="block mb-2 text-sm font-medium text-gray-100">bonificacion_auxilio</label>
                    <input type="number" id="bonificacion_auxilio" name="bonificacion_auxilio" value="{{ $sueldo->bonificacion_auxilio }}" class="bg-gray-900 border border-gray-300 text-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                </div>
